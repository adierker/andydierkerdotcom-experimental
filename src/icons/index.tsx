...
export const LinkedIn = ({className, url}: SocialIconProps) => (
...
export const Instagram = ({className, url}: SocialIconProps) => (
  <button onClick={() => openInNewTab(url)}>
    <svg xmlns="http://www.w3.org/2000/svg" className={`h-5 w-5 ${className}`} viewBox="0 0 24 24" fill="currentColor">
...
export const Github = ({className, url}: SocialIconProps) => (
  <button onClick={() => openInNewTab(url)}>
    <svg xmlns="http://www.w3.org/2000/svg" className={`h-5 w-5 ${className}`} viewBox="0 0 24 24" fill="currentColor">
