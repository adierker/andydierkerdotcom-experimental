...
export const addRecipeFormSchema: yup.SchemaOf<AddRecipeFormType> = yup
  ...
  .shape({
    ...
    isScalable: yup
      .string()
      .required(`Scalability is required.`)
      .nullable(true),
    descriptions: yup
      .array()
      .of(
    ...
    ingredientGroupings: yup
      ...
      .required(`At least one Ingredient Grouping is required.`),
    instructions: yup
      .array()
      .of(
        yup.object().shape({
          step: yup
            .string()
            .required(`Any visible Instruction field is required.`),
        })
      )
