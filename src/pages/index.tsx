...
export const getStaticProps = async (): Promise<GetStaticPropsResult<IndexPageProps>> => {
  const homePageContent = await getDocumentFromFirestore<HomePageContent>(COLLECTIONS.PAGES, '/home')
  const modalsContent = await getCollectionFromFirestore<ModalsContent>(COLLECTIONS.MODALS)
