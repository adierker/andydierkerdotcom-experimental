    ...
    <div className="flex min-h-screen">
      ...
      <main className="flex flex-col flex-1 items-center justify-start w-full px-10 xs:px-20 text-drkr-black">
        ...
        <div className="flex flex-col sm:flex-row justify-between w-full md:w-3/4 lg:w-1/2 mt-4 headline-spaced text-2xl underline">
          <button className="text-center hover:opacity-80" onClick={() => openModal(MODALS.ABOUT)}>about</button>
          <button className="text-center mt-2 sm:mt-0 hover:opacity-80" >resume</button>
          <button className="text-center mt-2 sm:mt-0 hover:opacity-80" onClick={() => openModal(MODALS.CONTACT)}>contact</button>
          <button className="text-center mt-2 sm:mt-0 hover:opacity-80" onClick={() => openModal(MODALS.PROJECTS)}>projects</button>
        </div>
        <div className="flex flex-row justify-between w-3/4 sm:w-1/2 min-w-max max-w-xxs mt-8 sm:mt-6">
          <Github className="h-10 w-10 flex-1 hover:opacity-80" url="https://github.com/adierker"/>
          <LinkedIn className="h-10 w-10 flex-1 hover:opacity-80" url="https://www.linkedin.com/in/dierker/"/>
          <Instagram className="h-10 w-10 flex-1 hover:opacity-80" url="https://www.instagram.com/dierker/"/>
        </div>
      </main>
